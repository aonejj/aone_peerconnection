...
//#include "rtc_base/gtest_prod_util.h"		// kimi disable
...
class SincResampler {
 ...
 private:
//  FRIEND_TEST_ALL_PREFIXES(SincResamplerTest, Convolve);				// kimi disable
//  FRIEND_TEST_ALL_PREFIXES(SincResamplerTest, ConvolveBenchmark);		// kimi disable
