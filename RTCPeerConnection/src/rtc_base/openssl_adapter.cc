...
OpenSSLAdapter::OpenSSLAdapter(AsyncSocket* socket,
							   RTCThreadManagerInterface *rtc_thread_manager,
...
AsyncSocket* OpenSSLAdapter::Accept(SocketAddress* paddr) {
  ...
  SSLAdapter* adapter = SSLAdapter::Create(socket, _rtc_thread_manager);
...
int OpenSSLAdapter::ContinueSSL() {
  ...
  Thread::Current(_rtc_thread_manager)->Clear(this, MSG_TIMEOUT);
  ...
  switch (SSL_get_error(ssl_, code)) {
    ...
    case SSL_ERROR_WANT_READ:
      ...
      if (DTLSv1_get_timeout(ssl_, &timeout)) {
		...
		Thread::Current(_rtc_thread_manager)->PostDelayed(RTC_FROM_HERE, delay, this, MSG_TIMEOUT,
			0);
      }
      break;
...
//////////////////////////////////////////////////////////////////////
OpenSSLAdapterFactory::OpenSSLAdapterFactory(RTCThreadManagerInterface* rtc_thread_manger)
	: _rtc_thread_manager(rtc_thread_manger) {}
