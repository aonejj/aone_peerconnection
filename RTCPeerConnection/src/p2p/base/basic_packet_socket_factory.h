...
class BasicPacketSocketFactory : public PacketSocketFactory {
 public:
  ...
  explicit BasicPacketSocketFactory(Thread* thread, RTCThreadManagerInterface *rtc_thread_manager );
  explicit BasicPacketSocketFactory(SocketFactory* socket_factory, RTCThreadManagerInterface *rtc_thread_manager);
 ...
 private:
  ...
  RTCThreadManagerInterface*	_rtc_thread_manager;
};
