...
class TurnPort : public Port {
 public:
  ...
  void SetThreadManagerToInvoker(rtc::RTCThreadManagerInterface* rtc_thread_manager) { 
	  invoker_.SetRTCThreadMananger(rtc_thread_manager);
	  _rtc_thread_mananger = rtc_thread_manager;
  }
 ...
 private:
  ...
  rtc::RTCThreadManagerInterface* _rtc_thread_mananger = nullptr;
};
