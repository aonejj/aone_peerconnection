...
BasicPacketSocketFactory::BasicPacketSocketFactory(
    ...
    : 
	thread_(Thread::Current(rtc_thread_manager)), socket_factory_(NULL),
	_rtc_thread_manager(rtc_thread_manager)
{}

BasicPacketSocketFactory::BasicPacketSocketFactory(Thread* thread, RTCThreadManagerInterface *rtc_thread_manager	)
...
AsyncPacketSocket* BasicPacketSocketFactory::CreateClientTcpSocket(
  ...
  if ((tlsOpts & PacketSocketFactory::OPT_TLS) ||
    ...
    SSLAdapter* ssl_adapter = SSLAdapter::Create(socket	, _rtc_thread_manager);
    if (!ssl_adapter) {
      return NULL;
    }
...
SocketFactory* BasicPacketSocketFactory::socket_factory() {
  if (thread_) {
	RTC_DCHECK(thread_ == Thread::Current(_rtc_thread_manager));
