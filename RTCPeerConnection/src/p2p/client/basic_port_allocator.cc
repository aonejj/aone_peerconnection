...
void BasicPortAllocator::InitRelayPortFactory(
  ...
  if (relay_port_factory != nullptr) {
	...
	default_relay_port_factory_.reset(new TurnPortFactory(_rtc_thread_manager));
...
BasicPortAllocatorSession::BasicPortAllocatorSession(
    ...
    : PortAllocatorSession(content_name,
	  ...
	  network_thread_(rtc::Thread::Current(rtc_thread_manager)),
...
void BasicPortAllocatorSession::AddAllocatedPort(Port* port,
  ...
  RTC_LOG(LS_INFO) << "AddAllocatedPort Adding allocated port for " << content_name();
...
void AllocationSequence::OnMessage(rtc::Message* msg) {
  RTC_DCHECK(rtc::Thread::Current(session_->_rtc_thread_manager) == session_->network_thread());
