...
class JsepTransportController : public sigslot::has_slots<> {
...
#else
	PeerConnectionInterfaceDefs::BundlePolicy bundle_policy =
		PeerConnectionInterfaceDefs::kBundlePolicyBalanced;
	PeerConnectionInterfaceDefs::RtcpMuxPolicy rtcp_mux_policy =
		PeerConnectionInterfaceDefs::kRtcpMuxPolicyRequire;
#endif
 ...
 private:
...
#else
  CallbackList<PeerConnectionInterfaceDefs::PeerConnectionState>
	  signal_connection_state_;

  CallbackList<PeerConnectionInterfaceDefs::IceConnectionState>
	  signal_standardized_ice_connection_state_;
#endif
  ...
  PeerConnectionInterfaceDefs::PeerConnectionState combined_connection_state_ =
