...
void WebRtcSessionDescriptionFactory::set_video_codecs(const cricket::VideoCodecs& send_codecs,
	const cricket::VideoCodecs& recv_codecs) {
	session_desc_factory_.set_video_codecs(send_codecs, recv_codecs);
}

void WebRtcSessionDescriptionFactory::set_rtp_data_codecs(const cricket::RtpDataCodecs& codecs) {
	session_desc_factory_.set_rtp_data_codecs(codecs);
}
