...
//////////////////////////////////////////////////////////////////////////
// kimi...
static void BuildRejectVideoMediaDescription(const ContentInfo* content_info,
											 std::string* message);
//////////////////////////////////////////////////////////////////////////
...
std::string SdpSerializeSessionDescription(cricket::SessionDescription* desc) {
	if (!desc) {
		return "";
	}
	...
	const std::string& session_version = jdesc.session_version().empty()
		...
		: jdesc.session_version();
#else
	const std::string& session_id = kSessionOriginSessionId;
	const std::string& session_version = kSessionOriginSessionVersion;
#endif
	os << " " << session_id << " " << session_version << " "
		<< kSessionOriginNettype << " " << kSessionOriginAddrtype << " "
		<< kSessionOriginAddress;
...
//////////////////////////////////////////////////////////////////////////
// add kimi
void BuildRejectVideoMediaDescription(const ContentInfo* content_info,
								 std::string* message) {
	rtc::StringBuilder os;
	std::string type = kMediaTypeVideo;
	std::string fmt = " 0";
	std::string port = "0";
	InitLine(kLineTypeMedia, type, &os);
	os << " " << port << " " << "RTP/SAVPF" << fmt;
	AddLine(os.str(), message);
...
void BuildMediaDescription(const ContentInfo* content_info,
  ...
  //////////////////////////////////////////////////////////////////////////
  // add kimi
  if (media_type == cricket::MEDIA_TYPE_VIDEO && content_info->rejected) {
	  BuildRejectVideoMediaDescription(content_info, message);
	  return;
  }
  //////////////////////////////////////////////////////////////////////////
