...
#ifndef __RTC_PC_RTC_DATA_CHANNEL_CONTROLLER_H__
#define __RTC_PC_RTC_DATA_CHANNEL_CONTROLLER_H__
...
//class RTCConnection;
class RTCConnectionInternal;


class RTCDataChannelController : public RtpDataChannelProviderInterface,
							     public SctpDataChannelProviderInterface,
							     public DataChannelSink {
public:
	explicit RTCDataChannelController(RTCConnectionInternal* pc,
		rtc::RTCThreadManagerInterface* rtc_thread_manager
		) : pc_(pc),
		_rtc_thread_manager(rtc_thread_manager)
	{
		data_channel_transport_invoker_.SetRTCThreadMananger(_rtc_thread_manager);
	}

	// Not copyable or movable.
	RTCDataChannelController(RTCDataChannelController&) = delete;
	RTCDataChannelController& operator=(const RTCDataChannelController& other) = delete;
	RTCDataChannelController(RTCDataChannelController&&) = delete;
	RTCDataChannelController& operator=(RTCDataChannelController&& other) = delete;
	...
	void set_rtp_data_channel(cricket::RTCRtpDataChannel* channel) {
...
private:
	...
	cricket::RTCRtpDataChannel* rtp_data_channel_ = nullptr;
...
//	RTCConnection* const pc_;
	RTCConnectionInternal* const pc_;

	rtc::WeakPtrFactory<RTCDataChannelController> weak_factory_{ this };
...
#endif // __RTC_PC_RTC_DATA_CHANNEL_CONTROLLER_H__
