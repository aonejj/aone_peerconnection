...
#ifndef __RTC_RTCP_RECEIVER_H__
#define __RTC_RTCP_RECEIVER_H__
...
public:
	...
	RTCRtcpReceiver(const RTCRtpRtcpInterface::Configuration& config,
		ModuleRtpRtcp* owner);
...
//	int32_t StatisticsReceived(std::vector<RTCPReportBlock>* receive_blocks) const;
	...
	absl::optional<RTCRtpRtcpInterface::RTCSenderReportStats> GetSenderReportStats() const;
...
private:
	...
	RTCRtpRtcpInterface::RTCSenderReportStats remote_sender_
